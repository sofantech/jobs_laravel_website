   ...
   <div class="row sidbare">
     <aside class="col-md-4">
        ...
        <ul class="nav-links">
          ...
          <li>
            <a href="dashboard-person-qualification.html" class="active">
     ...
     <div class="dashboard-section col-md-8">
       ...
       <div class="row person-qualification">
          <h2 class="text-center fs-4">المؤهل الدراسي</h2>
          <a type="button"  data-bs-toggle="modal" data-bs-target="#addModal">اضافة مؤهل دراسي</a>
          <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title flex-grow-1" id="exampleModalLabel">إضافة مؤهل دراسي</h5>
